...
public class AdminConfigController {
    ...
    @PostMapping("/basic")
    public String saveBasic(@RequestParam String action, RedirectAttributes ra) {
        switch (action) {
            case "save-site"      -> {/* 제목/부제 저장 */}
            case "save-logo"      -> {/* 로고 업로드 저장 */}
            case "save-company"   -> {/* 기업 정보 저장 */}
            case "save-support"   -> {/* 고객센터 저장 */}
            case "save-copyright" -> {/* 카피라이트 저장 */}
        }
