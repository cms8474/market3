...
public class AdminCsController {
    ...
    public String recruitList(@RequestParam(required = false) String searchType,
                              ...
                              @PageableDefault(size = 10, sort = "rRegDate", direction = Sort.Direction.DESC) Pageable pageable,
                              Model model) {

        Page<Recruitment> page = recruitmentService.search(searchType, keyword, pageable);
